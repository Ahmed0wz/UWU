...
function loadAllData() {
    ...
    loadLocation(); loadPrayerTimesCache(); loadJournal(); loadVariables(); loadShowPrayerTimes(); loadTasks();
}
...
function saveAllData() {
    ...
    saveLocation(); savePrayerTimesCache(); saveJournal(); saveVariables(); saveShowPrayerTimes(); saveTasks();
}
...
function renderSidebarContent() {
    ...
    sidebar.innerHTML = `
        ...
        <div class="flex-1 overflow-y-auto min-h-0">
            ...
            <!-- Tasks tab -->
            <div class="${state.sidebarView === 'tasks' || state.sidebarView === null ? '' : 'hidden'} flex flex-col animate-fade-in" style="min-height:100%">
                <!-- Period pills -->
                ...
                <!-- Task list -->
                <div class="flex-1 px-3 pb-2 space-y-1.5" style="overflow-y:auto">
...
function renderTaskList(dateStr) {
    ...
    return `
        ...
        <div class="flex items-center gap-2.5 px-2.5 py-2 rounded-xl ${task.completed ? 'theme-bg-tertiary opacity-60' : 'theme-bg-panel border theme-border'} transition-all">
            ...
            <button onclick="deleteTask('${dateStr}', ${idx})" class="shrink-0 p-0.5 rounded hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors">
