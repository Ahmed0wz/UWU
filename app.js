...
function openAccountSettings(e) {
    ...
    panel.className = 'fixed theme-bg rounded-xl shadow-2xl border theme-border overflow-hidden z-[200] w-72';
    panel.style.cssText = `bottom: ${window.innerHeight - rect.top + 8}px; left: ${rect.left}px;`;
    panel.innerHTML = `
